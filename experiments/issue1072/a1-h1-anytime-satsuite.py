...
for (factory_name,factory_str) in [("hm2","lm_hm(m=2)"), ("rhw","lm_rhw()")]:
	CONFIG_NICKS += [
            (f"lama-anytime-{factory_name}-pref",
                        ["--if-unit-cost",
                         "--evaluator",
                         f"hlm=lmcount(lm_reasonable_orders_hps({factory_str}),pref=true)",
                         "--evaluator", "hff=ff()",
                         "--search", """iterated([
                         ...
                         "--if-non-unit-cost",
                         "--evaluator",
                         f"hlm1=lmcount(lm_reasonable_orders_hps({factory_str}),transform=adapt_costs(one),pref=true)",
                         "--evaluator", "hff1=ff(transform=adapt_costs(one))",
                         "--evaluator",
                         f"hlm2=lmcount(lm_reasonable_orders_hps({factory_str}),transform=adapt_costs(plusone),pref=true)",
