...
protected:
    ...
    void proof_log_node_action_invariant(OperatorID op_id, SearchNode node, std::string comment);
    void proof_log_node_transition_invariant(SearchNode node, std::string comment);
    void proof_log_reif_state(State s, std::string comment);
